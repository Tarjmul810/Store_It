...
const Card = ({ file }: { file: Models.Document }) => {
    return <Link href={file.url}
        ...
        <div className="flex justify-between">
            <Thumbnail type={file.type} extension={file.extension} url={file.url} imageClassName="!size-11" />
        ...
        <div className="file-card-details">
            ...
            <p className="caption-1 text-light-100 line-clamp-1">By: {file.owner.fullName}</p>
        </div>
